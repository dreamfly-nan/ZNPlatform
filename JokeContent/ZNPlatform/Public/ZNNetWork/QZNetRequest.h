...
#import "QZResponseMessage.h"
#import "QZFileModel.h"
...
/*
 统一配置请求成功后执行的代码块
 */
@property (nonatomic , copy) QZResponseMessage * (^requestSuccess)(id _Nonnull responseObject);
...
+ (void)POST:(NSString * _Nonnull)urlStr
  ...
  dataModels:(NSArray<QZFileModel*> * _Nonnull)dataModels

...
- (void)setModel:(NewsDetailModel *)model{
    ...
    [self.imageV sd_setImageWithURL:[NSURL URLWithString:@""] placeholderImage:[UIImage imageNamed:InformationPlaceHoldImage]];
...
//    [self setupAutoHeightWithBottomViewsArray:@[self.authorLabel] bottomMargin:zn_AutoWidth(10)];
}
